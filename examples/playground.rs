...
fn _dev_population(pretty_print: bool, visualize: bool, print_jumper: bool, print_weights: bool) {
    ...
    for _ in 0..structural_mutation_size {
        ...
        if visualize {
            pop.render("examples/", print_jumper, print_weights);
        }
...
fn _test_specimen_mutation(
...

    {
        if export {
            ...
            specimen_origin.render(file_name, graph_name, print_jumper, print_weights);
        }
    ...
    for i in 0..generation_size {
...

        {
            if export {
                ...
                specimen_mutated.render(file_name, graph_name, print_jumper, print_weights);
            }
        }
    ...
    loop {
        ...
        for (i, specimen) in population.species.iter().enumerate() {
            ...
            if export {
                ...
                specimen.render(file_name, graph_name, print_jumper, print_weights);
            }
        }
        println!();
        ...
        for smi in 0..structural_mutation_size {
            ...
            for (i, offspring) in population.species.iter().enumerate() {
                ...
                if export {
                    ...
                    let graph_name: &str = "mutated";
                    // export_visu(&specimen_mutated, file_name, graph_name);
                    offspring.render(file_name, graph_name, print_jumper, print_weights);
                }
            }
            println!("\t\\\\\\  Evolution {}  ///\n\n", smi + 1);
            println!();
...
fn main() {
    ...
    _test_population_selection(pretty_print, visualize, print_jumper, print_weights);
